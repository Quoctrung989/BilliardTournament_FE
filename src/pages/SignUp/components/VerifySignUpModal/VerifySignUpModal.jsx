...
const VerifySignUpModal = ({ email, otp, onSetOtp, onSetOpenOtp }) => {
          ...
          <div className="flex-row px-12">
            ...
            <div className="w-full flex items-center mb-3">
              <span className="py-2 text-sm w-[70%]">
                Không nhận được mã?{" "}
                <label
                  className="font-semibold underline text-blue-800 cursor-pointer"
            ...
            <div className="flex w-full justify-center my-6">
              <div className="w-[80%] flex justify-around">
                <button
                  className="px-3 py-2 bg-gray-400 w-[45%] rounded-full text-black font-semibold duration-300 transition-all hover:opacity-70"
                  onClick={() => handleClosePop()}
                >
                  Huỷ
                </button>
                <button
                  className="px-3 py-2 bg-blue-700 w-[45%] rounded-full text-white font-semibold duration-300 transition-all hover:opacity-70"
                  onClick={() => handleSignUpReVerify()}
                >
                  Xác nhận
                </button>
              </div>
