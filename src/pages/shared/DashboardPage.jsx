...
import {
  hasCounts, shortMoney, donutOptions, areaTrendOptions, columnTrendOptions, barByStatusOptions,
            ...
            <AdminCard title="Giải đấu mới theo tháng" padding={false}>
              <div className="px-2 pb-2">
                <ChartOrEmpty
                  ...
                  options={columnTrendOptions(stats.tournaments.monthlyTrend, "Giải mới", "#06b6d4", isDark)}
                />
              </div>
            </AdminCard>
          </div>
            ...
            <AdminCard title="Giải đấu theo trạng thái" padding={false}>
              <div className="px-2 pb-2">
                <ChartOrEmpty
                  ...
                  options={donutOptions(stats.tournaments.byStatus, "Giải đấu", isDark)}
                />
              </div>
            </AdminCard>
            <AdminCard title="Đăng ký theo trạng thái" padding={false}>
              <div className="px-2 pb-2">
                <ChartOrEmpty
                  ...
                  options={donutOptions(stats.registrations.byStatus, "Đăng ký", isDark)}
                />
              </div>
            </AdminCard>
          </div>
            ...
            <AdminCard title="Trận đấu theo trạng thái" padding={false}>
              <div className="px-2 pb-2">
                <ChartOrEmpty
                  ...
                  options={barByStatusOptions(stats.matches.byStatus, "Trận đấu", isDark)}
                />
              </div>
            </AdminCard>
            <AdminCard title="Loại bi phổ biến" padding={false}>
              <div className="px-2 pb-2">
                <ChartOrEmpty
                  ...
                  options={barByStatusOptions(stats.tournaments.byGameType, "Giải đấu", isDark)}
                />
              </div>
            </AdminCard>
          </div>
